...
from transformers import MllamaConfig, MllamaImageProcessor, MllamaProcessor
...
class MllamaForConditionalGeneration(MllamaPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        if cross_attention_states is not None:
            cross_attention_states = cross_attention_states
            cross_attention_states = self.multi_modal_projector(cross_attention_states).reshape( # 需要调试
